...
//        log.info("cookie :{}",exchange.getHeaders().get("Set-Cookie"));
    ...
    public ResponseEntity<String> zsDtr(String str) {
        RestTemplate restTemplate = new RestTemplate();
        String urls = "http://192.168.90.163:4800/dtr/?ticket=" + str;
        //设置编码及转换器
        restTemplate.getMessageConverters().set(1,new StringHttpMessageConverter(StandardCharsets.UTF_8));
        //设置请求头
        HttpHeaders headers = new HttpHeaders();
        ...
        HttpEntity<String> entity = new HttpEntity<>(headers);
        //发送请求
        return restTemplate.exchange(urls, HttpMethod.GET, entity, String.class);
    }
}
